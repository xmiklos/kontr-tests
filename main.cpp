...
int main()
{
    kontr::Generator::Configuration &cg = kontr::Generator::Configuration::instance();
    ...
    std::cout << kontr::Names::get(Session, cg) << std::endl;
    std::cout << kontr::Names::get(master_testing, cg) << std::endl;
